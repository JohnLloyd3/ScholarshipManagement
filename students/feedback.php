...
<div class="page-header">
  <h1><i class="fas fa-star"></i> Feedback</h1>
</div>
...
<div class="content-card" style="margin-bottom:var(--space-xl);">
  <h2><i class="fas fa-file-alt"></i> Leave Feedback</h2>
  <?php foreach($pending as $app): ?>
    <div style="border:1px solid var(--gray-200);border-radius:var(--r-lg);padding:var(--space-lg);margin-top:var(--space-lg);">
      ...
      <?php if (!empty($app['disbursement_completed'])): ?>
        <span style="display:inline-block;background:#d1fae5;color:#065f46;padding:2px 10px;border-radius:9999px;font-size:0.8rem;font-weight:600;margin-bottom:var(--space-sm);"><i class="fas fa-money-bill-wave"></i> Disbursement received — please share your experience</span>
      <?php endif; ?>
