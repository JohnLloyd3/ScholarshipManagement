      ...
      <div class="content-card" style="display:flex;flex-direction:column;justify-content:space-between;gap:1rem;padding:1.25rem;">
        <div>
          <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:0.5rem;">
            ...
            <span style="background:#E8F5E9;color:#2E7D32;padding:2px 8px;border-radius:999px;font-size:0.7rem;font-weight:600;flex-shrink:0;margin-left:0.5rem;">Open</span>
          </div>
          <div style="font-size:0.8rem;color:#E53935;font-weight:500;margin-bottom:0.5rem;"><?= htmlspecialchars($s['organization'] ?? '') ?></div>
        ...
        <div style="border-top:1px solid #D1D5DB;padding-top:0.875rem;display:flex;justify-content:space-between;align-items:center;">
          <div>
